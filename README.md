...
- 💼 Previously at [Baseten](https://www.baseten.co/) as a Lead Software Engineer focused on model performance optimization, at [Meituan](https://www.meituan.com/en-US/about-us) working on GPU inference for CTR models using [TensorFlow](https://github.com/NVIDIA/tensorflow)/[TensorRT](https://github.com/NVIDIA/TensorRT) and LLMs with [PyTorch](https://github.com/pytorch/pytorch), and earlier at [Baidu](https://en.wikipedia.org/wiki/Baidu), familiar with [bRPC](https://github.com/apache/brpc) and [Babylon](https://github.com/baidu/babylon)

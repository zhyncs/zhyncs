...
- 🔭 I am a software engineer on the Model Performance Team at [Baseten](https://www.baseten.co/). I used to work at [Meituan](https://www.meituan.com/en-US/about-us), using [Tensorflow](https://github.com/NVIDIA/tensorflow), [TensorRT](https://github.com/NVIDIA/TensorRT) for CTR GPU Inference and [PyTorch](https://github.com/pytorch/pytorch) for LLM GPU Inference.
